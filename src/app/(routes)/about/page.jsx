      ...
      <main className="about-container">
        ...
        <section className="about-hero">
          ...
          <p className="about-p-tag">
            We are a modern freelance marketplace connecting clients with
            skilled professionals. Businesses can post jobs, set their
            requirements, and receive applications from freelancers ready to
        ...
        <section className="about-content">
          ...
          <p className="about-p-tag">
            ...
            meets talent. We empower clients to find the right expertise
            quickly, while giving freelancers access to meaningful projects and
            secure payments for the work they complete.
          </p>
        </section>
        ...
        <section className="about-content">
          <h2>Why We Exist</h2>
          <p className="about-p-tag">
            Finding reliable freelancers and trustworthy clients shouldn&apos;t
            be complicated. We exist to simplify the hiring process, provide a
            safe and transparent workflow, and ensure freelancers get paid for
