...
export default function Home() {
  return (
    <div className="home-page-container">
      ...
      <TextSlide>
        <p className="home-page-subtitle">Post Jobs.</p>

        <p className="home-page-subtitle">Get Hired.</p>

        <p className="home-page-subtitle"> Get Paid.</p>
      </TextSlide>

      <TextSlide>
        <p className="hero-subtitle">
          Clients can post projects in minutes and connect with qualified
          freelancers ready to deliver.
        </p>

        <p className="hero-subtitle">
          Freelancers apply, complete work, and get paid securely — without
          chasing invoices.
        </p>
      </TextSlide>
      ...
      <div className="feature-card-container">
        <TextAnimation>
          <div className="feature-card">
            ...
            <p>
              Showcase skills, experience, and past work in a professional
              profile that builds trust and credibility with potential clients.
            </p>
          </div>
        </TextAnimation>
        <TextAnimation>
        ...
        <TextAnimation>
          <div className="feature-card">
            ...
            <p>
              Communicate safely within TrueHire to discuss details, share
